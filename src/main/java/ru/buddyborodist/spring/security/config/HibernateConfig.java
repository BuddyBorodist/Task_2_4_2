package ru.buddyborodist.spring.security.config;
...
@ComponentScan("ru.buddyborodist.spring.security")
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManager.setPackagesToScan("ru.buddyborodist.spring.security.model");
